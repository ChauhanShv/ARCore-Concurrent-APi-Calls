...
package com.app.powerhouseapp.presentation.depth;
...
import com.app.powerhouseapp.arcore.common.depth.DepthTextureHandler;
import com.app.powerhouseapp.arcore.common.helpers.CameraPermissionHelper;
import com.app.powerhouseapp.arcore.common.helpers.DisplayRotationHelper;
import com.app.powerhouseapp.arcore.common.helpers.FullScreenHelper;
import com.app.powerhouseapp.arcore.common.helpers.SnackbarHelper;
import com.app.powerhouseapp.arcore.common.helpers.TapHelper;
import com.app.powerhouseapp.arcore.common.helpers.TrackingStateHelper;
import com.app.powerhouseapp.arcore.common.rendering.BackgroundRenderer;
import com.app.powerhouseapp.arcore.common.rendering.ObjectRenderer;
import com.app.powerhouseapp.arcore.common.rendering.OcclusionObjectRenderer;
 ...
 */
public class DepthFinderActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  private static final String TAG = DepthFinderActivity.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.depth_main);
...
//      // Retrieve the depth image for the current frame, if available.
      ...
      try {
        depthImage = frame.acquireDepthImage();
          Log.e("depthImage",depthImage.getTimestamp()+" ==>"+ depthImage.getPlanes()[0].getBuffer()+" ==>"+ depthImage.getHeight()+" "+depthImage.getWidth());
